...
const TRICKS={
 ...
 modals:{"t": "Modales", "items": ["Después de can, must, should o might la acción va limpia: sin to y sin -s. He can play, no He can plays.", "Prohibido, como una señal de NO, es mustn't. No hace falta, lo haces si quieres, es don't have to.", "Must y have to son casi iguales: tener que. Con él o ella, have to cambia: she has to.", "Para hablar del pasado de must se usa had to: Yesterday I had to walk.", "Busca la idea: ¿consejo? should. ¿Quizás? might. ¿Casi seguro? must be. ¿Imposible? can't be.", "Para pedir algo con amabilidad: Could you...? Para pedir permiso muy educado: May I...?"]},
