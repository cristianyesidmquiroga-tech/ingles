...
const TRICKS={
 ...
 modals_ab:{"t": "Can y could", "items": ["Can es puedo ahora: I can swim. Could es pude o podía en el pasado: I couldn't swim when I was a child.", "Después de can o could la acción va limpia: sin to y sin -s. He can play, no He can plays.", "Para pedir permiso se usa Can I...? Para una petición más cortés se usa Could you...?"]},
 modals_ob:{"t": "Must, have to y mustn't", "items": ["Después de must la acción va limpia: sin to y sin -s. He must play, no He must plays.", "Mustn't es una señal de prohibido: significa que no lo puedes hacer.", "Don't have to es distinto: no es obligatorio pero si quieres lo haces igual.", "Must es debo, una obligación que decides tú. Have to es tengo que, una obligación que viene de una regla o de otra persona. Con él o ella, have to cambia: she has to.", "Para hablar del pasado de must se usa had to: Yesterday I had to walk."]},
 modals_ad:{"t": "Should y consejos", "items": ["Should es un consejo: deberías. Shouldn't es el consejo contrario: no deberías.", "Si la idea es un consejo, va should."]},
 modals_po:{"t": "May, might y deducciones", "items": ["Busca la idea: ¿quizás? might o may. ¿Casi seguro? must be. ¿Imposible? can't be."]},
 modals_rq:{"t": "Pedir y ofrecer con cortesía", "items": ["Para pedir algo con amabilidad: Could you...? Para pedir permiso muy educado: May I...?"]},
 modals:{"t": "Modales", "items": ["Can es puedo ahora: I can swim. Could es pude o podía en el pasado: I couldn't swim when I was a child.", "Después de can, must, should o might la acción va limpia: sin to y sin -s. He can play, no He can plays.", "Para pedir permiso se usa Can I...? Para una petición más cortés se usa Could you...?", "Mustn't es una señal de prohibido: significa que no lo puedes hacer.", "Don't have to es distinto: no es obligatorio pero si quieres lo haces igual.", "Must es debo, una obligación que decides tú. Have to es tengo que, una obligación que viene de una regla o de otra persona. Con él o ella, have to cambia: she has to.", "Para hablar del pasado de must se usa had to: Yesterday I had to walk.", "Should es un consejo: deberías. Shouldn't es el consejo contrario: no deberías.", "Busca la idea: ¿quizás? might o may. ¿Casi seguro? must be. ¿Imposible? can't be.", "Para pedir algo con amabilidad: Could you...? Para pedir permiso muy educado: May I...?"]},
...
const TRICK_BY_LEVEL=[['g5_seq','conn'],['g5_port','reading'],['g5_can','modals_ab'],['g5_should','modals_ad'],['g5_must','modals_ob'],['g5_','modals'],['ps','ps'],['pc','pc'],['pp','pp'],['mix','mixed'],['ut','used'],['pr','pron'],['pn','ed'],['m_ab','modals_ab'],['m_ob','modals_ob'],['m_ad','modals_ad'],['m_po','modals_po'],['m_rq','modals_rq'],['m_','modals'],['md','modals'],['c_read','reading'],['c_','conn'],['cn','conn'],['pv','phrasal'],['or','exam'],['o4','exam'],['o5','exam'],['au','reading'],['ex','exam']];
